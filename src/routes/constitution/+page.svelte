...
<div class="constitution">
    ...
    <p>At the end of the season 6 teams will make the playoffs. The first round of playoffs will commence in week 15. The top two teams, according to the standings, will receive a bye week. The remaining four teams will be seeded accordingly.  Each playoff matchup will only last one week and the winner will advance. Week 18 will not be used.</p>
    <p>The last two teams, according to the standings after week 14, will play each other in the toilet bowl. The toilet bowl will be one game that is played during week 15. The loser of this, is the loser of the league and will be subjected to a punishment.</p>
...
<p>2. The beer mile is consist of 4 Beers and 4 Laps (one mile). Each lap is to be 400m in length and to be preceded by a beer. The runner will start with a beer and finish the beer before starting to run the first lap; this will be repeated 4 times. The beers or alcoholic beverages  need to be a minimum of 12 fl. oz, a minium of 5.0% ABV, and canned or bottled (no draft beers or wide mouth cans). If the runner is to leave for the lap before the beer is confirmed empty, there will be a penalty. If there is excessive spilling, there will be a penalty. To prove that there is an empty can, the runner is to hold the empty can abover their head upside down. The goal is to have all four beers consumed and the mile completed under a time frame of 12 mintues. If the runner is unable to get this completed within the time frame set by the league, he is to repeat the attempt as many times as needed for a successful attempt.</p>
        <li>5K in Hallowen Cosutume</li>
<p>A 5k is to be completed, preferably a community sanctioned event. The runner is to wear a costume that is voted upon by the league and the run is to be completed 
        <li>Spray Tan</li>
<p>
        <li>Mcdonald's Challenge</li>
<p>
        <li>Buy Rounds</li>
<p>
...
<p>
   ...
   <h2 class="sectionHeading" bind:this={five}>Section 5 Tanking Policy</h2>
    ...
    <p>When a manager needs to be replaced, the commisiooners will try to find a suitable candidate with some connection to at least a portion of the existing managers. Priority will be placed on managers who are eager to take on a keeper league commitment and will be very active within the league.</p>
